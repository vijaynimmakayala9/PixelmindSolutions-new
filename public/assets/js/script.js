...
(function ($) {
    ...
    function mousecursor() {
        if (document.querySelector("body")) {
            ...
            let t = document.querySelector(".cursor-outer"); // Changed const to let
    ...
    var caseSwiper = new Swiper(".case__slider", {
        loop: true,
        spaceBetween: 24,
        speed: 800,
        autoplay: {
    ...
    var caseTwoSwiper = new Swiper(".case-two__slider", {
        loop: true,
        spaceBetween: 24,
        speed: 500,
        autoplay: {
    ...
    var testimonialTwoSwiper = new Swiper(".testimonial-two__slider", {
        loop: true,
        spaceBetween: 24,
        speed: 800,
        autoplay: {
    ...
    var testimonialThreeSwiper = new Swiper(".testimonial-three__slider", {
        loop: true,
        spaceBetween: 24,
        speed: 300,
        autoplay: {
    ...
    var serviceSwiper = new Swiper(".service-two__slider", {
        loop: true,
        spaceBetween: 30,
        speed: 500,
        autoplay: {
    ...
    // Background image data area start here ***
